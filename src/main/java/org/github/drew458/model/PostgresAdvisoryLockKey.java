 ...
 */
public class PostgresAdvisoryLockKey {
    ...
    /**
     * Constructs a key based on a string "name".
     * <p>
     ...
     * @param allowHashing
     */
    public PostgresAdvisoryLockKey(@NonNull String name, boolean allowHashing) throws Exception {
                        ...
                        throw new Exception(
                                String.format(
                                        "Name '%s' could not be encoded. Please specify allowHashing) or use one of the following formats:" +
                                                " or (1) a 0-%s character string using only ASCII characters" +
                                                ", (2) a %s character hex string, such as the result of %s " +
                                                ", or (3) a 2-part, %s character string of the form XXXXXXXX%sXXXXXXXX, where the X's are %s hex strings" +
                                                " such as the result of Int32.MaxValue.ToString(\"x%s\")." +
                                        ...
                                        name, MAX_ASCII_LENGTH, HASH_STRING_LENGTH, Integer.MAX_VALUE, SEPARATED_HASH_STRING_LENGTH, HASH_STRING_SEPARATOR, HASH_PART_LENGTH, HASH_PART_LENGTH)
                        );
                    }
                }
            }
